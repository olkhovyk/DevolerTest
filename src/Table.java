...
public class Table  {
    ...
    public void setRobotStrategy() throws IOException {
        System.out.println("¬ведите номера стратегий (1-3) дл€ 6 роботов");
        System.out.println("»ли 0 - дл€ выхода");
        while (i != 6){
            ...
            if(j == 1 || j == 2 || j ==3){
                ...
                System.out.println("¬ведено неправильное число, повторите ввод");
            }
        }
